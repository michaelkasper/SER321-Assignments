...
public class WaypointGUI extends JFrame {
   ...
   public WaypointGUI(String title) {
      ...
      frWps.setModel(new SortedComboBoxModel<>());
      ...
      toWps.setModel(new SortedComboBoxModel<>());
   ...
   public class SortedComboBoxModel<E extends Comparable<? super E>> extends DefaultComboBoxModel<E> {
      ...
      public void insertElementAt(E element, int index) {
         ...
         for (index = 0; index < size; index++) {
            ...
            if (index != 0 && c.compareTo(element) > 0) {
               break;
            }
         }
