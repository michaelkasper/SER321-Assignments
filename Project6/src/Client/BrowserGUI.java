...
public class BrowserGUI extends JFrame {
    ...
    public BrowserGUI(String path) {
        ...
        htmlPane.setEditorKitForContentType("application/rtf", new RTFEditorKit());
        htmlPane.setEditorKitForContentType("text/html", new HTMLEditorKit());

        JScrollPane htmlView = new JScrollPane(htmlPane, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
